...
class SearchAggregation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchAggregation';
     ...
     * Sets total_count
     *
     * @param int|null $total_count The total number of items that match the request
     *
     * @return $this
     */
     ...
     * Sets skip
     *
     * @param int|null $skip The number of items that were skipped
     *
     * @return $this
     */
     ...
     *
     * @param string|null $scroll_identifier The scroll identifier which can be used in a subsequent search request to fetch the next page. Expires in 60 seconds.
     *
     * @return $this
     */
