...
/**
 * ProductShippingRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class ProductShippingRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductShippingRequest';
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling ProductShippingRequest., must be smaller than or equal to 2.');
        }
    ...
    public function setSendGoodsCountry($send_goods_country)
    {
        if (!is_null($send_goods_country) && (mb_strlen($send_goods_country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $send_goods_country when calling ProductShippingRequest., must be smaller than or equal to 2.');
        }
     ...
     * Sets quantity
     *
     * @param int|null $quantity Quantity that will be purchased
     *
     * @return $this
     */
